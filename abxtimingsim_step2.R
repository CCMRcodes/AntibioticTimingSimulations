...
#               
# Author:       Sarah Seelye (adapted from code written by Brenda McGrath)
#
...
happi<-read_dta("I:/HAPPI/5. Identifiable Data/Sarah/analysis/Aim3/data/kp_va_happi_aim3_20221103.dta") #1559523 obs, 183 vars
